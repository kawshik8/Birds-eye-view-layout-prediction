...
class ResNet(nn.Module):
    ...
    def __init__(self, architecture, stage5=False):
        ...
        self.C1 = nn.Sequential(
            nn.Conv2d(3*6, 64, kernel_size=7, stride=2, padding=3),
...
class MaskRCNN(nn.Module):
    ...
    def train_model(self, train_dataset, val_dataset, learning_rate, epochs, layers):
        ...
        NUM_VALI_SET = 5
        train_set = LabeledDataset(image_folder="../data", annotation_file="../data/annotation.csv", 
                                   scene_index=np.arange(106, 134-NUM_VALI_SET), transform=None)
        train_generator = torch.utils.data.DataLoader(train_set, batch_size=1, shuffle=True, num_workers=4)
        val_set = LabeledDataset(image_folder="../data", annotation_file="../data/annotation.csv", 
                                 scene_index=np.arange(134-NUM_VALI_SET, 134), transform=None)
        val_generator = torch.utils.data.DataLoader(val_set, batch_size=1, shuffle=True, num_workers=4)
